...
* [Download repository ke dalam komputer](http://https://github.com/heri99123/README#Download-repository)
* [Update repository yang telah diunduh](https://github.com/heri99123/repo-document1#Update-repository)
* [Upload perubahan ke dalam repository](https://github.com/heri99123/repo-document1#Upload-perubahan)
* [Delete File](https://github.com/heri99123/repo-document1#menghapus-file)
* [Branching](https://github.com/heri99123/repo-document1#branching)
* [Other Command](https://github.com/heri99123/repo-document1#perintah-tambahan)
* [heri.saja](https://github.com/heri99123/repo-document1#heri.saja)
...
```
user@host:~$ git clone https://github.com/heri99123/repo-document1.git instagram
...
```
git pull https://github.com/heri99123/repo-document1.git master
From https://github.com/heri99123/instagram
...
To https://github.com/heri99123/repo-document1.git
...
remote:   https://github.com/heri99123/pull-requests/new?source=new&t=1
remote:
To https://github.com/heri99123/repo-document1.git
...
## heri.saja
Ada kalanya kita melihat file readme.md di suatu repository. Apakah itu heri.saja? heri.saja adalah file yang berisi instruksi kepada git repository untuk tidak men-track files tertentu. Ini sangat berguna untuk meng-exclude files yang mungkin tidak berguna atau tidak perlu di push ke repository. Contoh: .DS_Store di Mac, binary files, `__pycache__`, etc. 

file readme.md dimulai dengan titik (`.`) di Unix-based system (Mac dan Linux) untuk menandakan dia adalah hidden file. Di Windows, buat file readme.md dengan memberi nama `.heri.saja`.
